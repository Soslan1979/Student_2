...
public class Array {
    public static void main(String[] args) {
        ...
        number[0] = 10; // внесли в массив значение 10 по индексу 0
                                   ...
                                   // индекс массива:    [0, 1, 2, 3, 4]
        System.out.println(Arrays.toString(number)); // Выводим весь массив: [10, 0, 0, 0, 0]
        System.out.println(number[0]); // Выводим значение по индексу: 10
        int[] num = {1, 2, 3};     // инициализируем массив и сразу заполняем значениями
